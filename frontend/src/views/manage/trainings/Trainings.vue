...
import BulletinAdd from './TrainingsAdd.vue'
import BulletinEdit from './TrainingsEdit.vue'
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/trainings/' + ids).then(() => {
