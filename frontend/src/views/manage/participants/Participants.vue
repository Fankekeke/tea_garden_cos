...
import BulletinAdd from './ParticipantsAdd.vue'
import BulletinEdit from './ParticipantsEdit.vue'
...
export default {
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/activity-participants/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/cos/activity-participants/page', {
        ...params
      }).then((r) => {
